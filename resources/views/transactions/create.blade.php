<x-app-layout>
    ...
    <div class="max-w-4xl mx-auto py-10 px-6">
        <form action="{{ route('transactions.store') }}" method="POST" class="space-y-6 bg-[#fdfcf7] p-6 rounded-xl shadow-sm border border-gray-200">
            @csrf
            ...
            <div>
                ...
                <div id="product-fields" class="space-y-3">
                    {{-- Template pertama kosong, akan ditambah lewat JS --}}
                </div>
